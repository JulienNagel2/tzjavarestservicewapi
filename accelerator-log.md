...
```json
{
  "apiDescription" : "The API for the restful app jng ",
  "apiOwner" : "jngapiowner",
  "apiSystem" : "jngapisystem",
  ...
  "projectName" : "java-rest-service-wapi",
  "sourceRepositoryPrefix" : "jngharbor.allintanzu.com/tap1.3.2/jngsupplychain"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#exposeOpenAPIEndpoint) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [DESCRIPTION_VAL->The API for the rest...(truncated), OWNER_VAL->jngapiowner, SYSTEM_VAL->jngapisystem]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [dev.local->jngharbor.allintanzu...(truncated)]
